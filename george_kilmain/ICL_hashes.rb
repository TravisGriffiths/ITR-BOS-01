...
#
responses = {:positive=>["It is certain", "It is decidely so", "Without a doubt", "Yes - definitely", "You may rely on it", "As I see it, yes", "Most likely", "Outlook good", "Yes", "Signs point to yes"]}
#puts responses
...
responses[:negative] = ["Don't count on it", "My reply is no", "My sources say no", "Outlook no so good", "Very doubtful"]
#puts responses
...
#puts responses.has_key?(:positive)



# 4. Check to see if it has the key `:cruel`

#puts responses.has_key?(:cruel)
