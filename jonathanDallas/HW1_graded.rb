...
# JC - if you'd like to create double line breaks, one alternative is adding '/n
# JC - to the end of one of your previous lines. Your solution works fine as well though
puts ""
