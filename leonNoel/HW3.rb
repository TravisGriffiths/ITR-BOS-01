...
#1
#Not sure what lab 2 was... It's not marked anywhere online or on github
...
#5
guess_count = 3 #setting a count to display what guess they are on
count = 3 #count for my loop
while (count > 0)
	puts "Make your guess. You have #{guess_count} left. "
