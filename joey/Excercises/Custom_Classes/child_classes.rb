...
#		- initialize(string1, string2) - Initializes the food_type instance variable to a string that is the type of food the animal eats 
# AND uses the super keyword to initialize #the pet_name and zoo_keeper variables which are passed in as arguments. 
