...
class GeosControllerTest < ActionController::TestCase
  ...
  test "should create geo" do
    assert_difference('Geo.count') do
      post :create, geo: { CityName: @geo.CityName, CountryId: @geo.CountryId, CountryName: @geo.CountryName }
    end
  ...
  test "should update geo" do
    put :update, id: @geo, geo: { CityName: @geo.CityName, CountryId: @geo.CountryId, CountryName: @geo.CountryName }
    assert_redirected_to geo_path(assigns(:geo))
  end
