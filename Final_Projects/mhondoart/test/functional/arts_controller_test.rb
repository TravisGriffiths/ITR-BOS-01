...
class ArtsControllerTest < ActionController::TestCase
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post :create, art: { artname: @art.artname, artpath: @art.artpath, artprice: @art.artprice, artsize: @art.artsize, mediatype: @art.mediatype, metadata: @art.metadata }
    end
  ...
  test "should update art" do
    put :update, id: @art, art: { artname: @art.artname, artpath: @art.artpath, artprice: @art.artprice, artsize: @art.artsize, mediatype: @art.mediatype, metadata: @art.metadata }
    assert_redirected_to art_path(assigns(:art))
  end
