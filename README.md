...
* add x -> Add a file/folder to the commit to be pushed
...
* When working from a command line, you will need to use git add to add changed files to a commit, most IDEs will do this automatically
